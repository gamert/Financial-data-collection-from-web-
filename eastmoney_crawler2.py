...
def set_table():
    ...
    set_talbe_param(date,tables)

# @date:2019-06-30  2019-09-31
# @tables [1,7]
def set_talbe_param(date,tables):
...
def _build_file_name(category):
    return '{}_{}_{}.csv'.format(category, year, quarter)
# 写入表头
# 方法1 借助csv包，最常用
def write_header(data,category):
    with open(_build_file_name(category), 'a', encoding='utf_8_sig', newline='') as f:
